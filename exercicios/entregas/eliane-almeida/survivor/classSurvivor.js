...
import { Level } from '../classLevels.js';
import { GameCharacter } from '../classCharacter.js';
import { Equipment } from '../classEquipment.js';
import { AbilitiesTree }from '..classAilitiesTree.js';

export class Survivor extends GameCharacter {
	name;
	abilitiesTree;
	unlockedAbilities = [];
	handsEquipments = [];

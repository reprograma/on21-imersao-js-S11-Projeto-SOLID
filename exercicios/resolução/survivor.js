...
class SurvivorPoints extends SurvivorUtils {
  constructor(survivor) {
    super(survivor);
  }
...
class SurvivorLevel extends SurvivorUtils {
  constructor(survivor, survivorAbilitiesTree) {
    super(survivor);
    if (survivorAbilitiesTree instanceof SurvivorAbilitiesTree) {
      this.survivor.survivorAbilitiesTree = survivorAbilitiesTree;
    }
  }
  ...
  checkLevel() {
    ...
    if (this.survivor.point === 150) {
      registerMessage("Fim de jogo, parabéns!");
    }
  }
}
...
class SurvivorHurts extends SurvivorUtils {
  ...
  getHurt() {
    if (this.survivor.alive) {
      this.survivor.hurts++;
      if (this.survivor.handsEquipments > 0) {
        this.survivor.handsEquipments--;
      } else if (this.survivor.bagEquipments > 0) {
        this.survivor.bagEquipments--;
      }
